  ...
  const CodeServiceContent = () => (
    ...
    >
      ...
      >
        ...
        <span className={classes.codeKeyword}>function{" "}<span className={classes.codeProperty}>{" "}response(msg)&#123;</span></span>
  ...
  return (
    ...
    >
      ...
      <MotionTypography
        ...
        variants={itemVariants}
      >
        With deep expertise, we deliver quality solutions that drive success and
        exceed industry standards consistently.
      </MotionTypography>
      ...
      {/* Small Service Cards - Bottom Row */}
      <MotionContainer maxWidth="md" variants={containerVariants}>
        <Grid container spacing={2}>
